                ...
                <div className="form-container">
                    ...
                    <form className="auth-form" onSubmit={(e) => {
                        ...
                        <div className="form-input-container">
                            ...
                            <input type="password" id="passwordGiven" className="auth-input" placeholder='******' name="password" onChange={
                                (e) => {
                                    fetchAndSetFormInputValues(e, setLoginData);
                                }
                            } required />
                    ...
                    <div className="form-actions flex-column gentle-flex-gap flex-align-center">
                        <p>
                            <button className='px-2 py-3 hero-btn hero-btn-primary'
                                onClick={(e) => {
                                    loginSubmissionHandler(e, guestCredentials, setAuthState, navigate);
                                }}>GUEST LOGIN</button>
                        </p>
                        <p>
