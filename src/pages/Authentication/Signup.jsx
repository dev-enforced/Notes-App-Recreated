                ...
                <div className="form-container">
                    ...
                    <form className="auth-form" onSubmit={(e) => {
                        ...
                        <div className="form-input-container">
                            ...
                            <input type="text" id="firstNameGiven" name="firstName" className="auth-input" onChange={(e) => {
                                fetchAndSetFormInputValues(e, setSignupData);
                            }} placeholder='e.g Krish' required />
                        </div>
                        <div className="form-input-container">
                            <label htmlFor="lastNameGiven" className="form-input-label">
                                Last Name
                            </label>
                            <input type="text" id="lastNameGiven" name="lastName" className="auth-input" placeholder='e.g Patel' onChange={(e) => {
                                fetchAndSetFormInputValues(e, setSignupData);
                            }} required />
                        </div>
                        <div className="form-input-container">
                            ...
                            <input type="email" id="emailGiven" name="email" className="auth-input" placeholder='krishpatel@gmail.com' onChange={(e) => {
                                fetchAndSetFormInputValues(e, setSignupData);
                            }} required />
                        </div>
                        <div className="form-input-container">
                            ...
                            <input type="password" id="passwordGiven" name="password" className="auth-input" placeholder='******' onChange={(e) => {
                                fetchAndSetFormInputValues(e, setSignupData);
                            }} required />
                        </div>
