...
return (
    <form className='note-input-container' onSubmit={(e) => noteFormSubmissionOperator(e)} style={{ backgroundColor: noteData.color }}>
        ...
        <div className="gentle-flex flex-space-between p-4">
            ...
            <button type="submit" className={`btn btn-primary ${noteData.title.trim() === "" || (noteData.editorContent === "" || noteData.editorContent === "<p><br></p>") ? "btn-disabled" : ""}`}>
